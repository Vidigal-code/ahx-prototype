const AHX_CONFIG = {
  ...
  navigation: [
    ...
    { id: "chat", route: "chat", labelKey: "chat" },
...
const AHX_TRANSLATIONS = {
  en: {
    ...
    chatPageTitle: "AI task chat",
    chatPageSubtitle: "Simulate an assistant that creates, edits, or deletes personal diary tasks.",
    chatAssistantIntro: "What do you want to do: start a new task, edit a task, or delete a task?",
    chatModeSearch: "Guided search mode",
    chatModeSearchText: "Answer each step. I will confirm yes or no before generating the diary action JSON.",
    chatChooseAction: "Choose an action",
    chatCreateTask: "Start new task",
    chatEditTask: "Edit task",
    chatDeleteTask: "Delete task",
    chatCategory: "Category",
    chatDiaryTask: "Diary task",
    chatMessagePlaceholder: "Type your answer...",
    chatTaskQuestion: "What is the task name?",
    chatDetailsQuestion: "What details should I include?",
    chatEditQuestion: "What do you want to change in this task?",
    chatDeleteQuestion: "Are you sure you want to delete this task? Type yes or no.",
    chatConfirmQuestion: "Confirm this action? Type yes or no.",
    chatYes: "yes",
    chatNo: "no",
    chatJsonReady: "Standard JSON generated for diary import.",
    chatCancelled: "Action cancelled.",
    chatDeleteButton: "Delete task",
    send: "Send",
    low: "Low",
    medium: "Medium",
    high: "High",
  ...
  pt: {
    ...
    chatPageTitle: "Chat de tarefas com IA",
    chatPageSubtitle: "Simule um assistente que cria, edita ou exclui tarefas do diario pessoal.",
    chatAssistantIntro: "O que voce quer fazer: iniciar uma nova tarefa, editar uma tarefa ou excluir uma tarefa?",
    chatModeSearch: "Modo de pesquisa guiada",
    chatModeSearchText: "Responda cada etapa. Eu confirmo sim ou nao antes de gerar o JSON da acao do diario.",
    chatChooseAction: "Escolha uma acao",
    chatCreateTask: "Iniciar nova tarefa",
    chatEditTask: "Editar tarefa",
    chatDeleteTask: "Excluir tarefa",
    chatCategory: "Categoria",
    chatDiaryTask: "Tarefa do diario",
    chatMessagePlaceholder: "Digite sua resposta...",
    chatTaskQuestion: "Qual e o nome da tarefa?",
    chatDetailsQuestion: "Quais detalhes devo incluir?",
    chatEditQuestion: "O que voce quer alterar nesta tarefa?",
    chatDeleteQuestion: "Tem certeza que deseja excluir esta tarefa? Digite sim ou nao.",
    chatConfirmQuestion: "Confirma esta acao? Digite sim ou nao.",
    chatYes: "sim",
    chatNo: "nao",
    chatJsonReady: "JSON padronizado gerado para importacao no diario.",
    chatCancelled: "Acao cancelada.",
    chatDeleteButton: "Excluir tarefa",
    send: "Enviar",
    low: "Baixa",
    medium: "Média",
    high: "Alta",
  ...
  es: {
    ...
    chatPageTitle: "Chat de tareas con IA",
    chatPageSubtitle: "Simula un asistente que crea, edita o elimina tareas del diario personal.",
    chatAssistantIntro: "Que quieres hacer: iniciar una nueva tarea, editar una tarea o eliminar una tarea?",
    chatModeSearch: "Modo de busqueda guiada",
    chatModeSearchText: "Responde cada paso. Confirmare si o no antes de generar el JSON de accion del diario.",
    chatChooseAction: "Elige una accion",
    chatCreateTask: "Iniciar nueva tarea",
    chatEditTask: "Editar tarea",
    chatDeleteTask: "Eliminar tarea",
    chatCategory: "Categoria",
    chatDiaryTask: "Tarea del diario",
    chatMessagePlaceholder: "Escribe tu respuesta...",
    chatTaskQuestion: "Cual es el nombre de la tarea?",
    chatDetailsQuestion: "Que detalles debo incluir?",
    chatEditQuestion: "Que quieres cambiar en esta tarea?",
    chatDeleteQuestion: "Seguro que quieres eliminar esta tarea? Escribe si o no.",
    chatConfirmQuestion: "Confirmas esta accion? Escribe si o no.",
    chatYes: "si",
    chatNo: "no",
    chatJsonReady: "JSON estandar generado para importar en el diario.",
    chatCancelled: "Accion cancelada.",
    chatDeleteButton: "Eliminar tarea",
    send: "Enviar",
    low: "Baja",
    medium: "Media",
    high: "Alta",
...
const AHX_ICON_PROVIDER_MAP = {
  ...
  "badge-check": "tabler:circle-check",
